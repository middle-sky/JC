...
model = Sequential()
model.add(Dense(5, input_shape=(6,),use_bias=False))
...
#학습
hist2 = model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=500,verbose=0)
